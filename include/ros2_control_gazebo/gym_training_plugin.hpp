...
#include <ros2_control_interfaces/srv/create_marker.hpp>

namespace gazebo_plugins {
    using GetSimTime = ros2_control_interfaces::srv::GetCurrentSimTime;
    using CreateMarker = ros2_control_interfaces::srv::CreateMarker;
    ...
    private:
        ...
        rclcpp::Service<CreateMarker>::SharedPtr mode_model_srv_;
        ...
        void handle_CreateMarker(const std::shared_ptr<rmw_request_id_t> &request_header,
